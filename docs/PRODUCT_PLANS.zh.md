...
本方案基于 Whale Staking 合约架构，提供一套独立的产品方案，分别面向不同用户群体：

- **Staking（委托质押）**：面向普通用户，低门槛、稳健收益
- **（高级质押）**：面向大户/机构，高门槛、高收益
...
- **用户沟通**：及时与大户沟通，提供专属服务
- **大户 DID 提醒**： 用户均符合大户 DID 条件（最低门槛 50万 HSK），及时提醒用户去 mint 大户 DID
...
- 用户选择 365 天锁定期，年化 5%
- 实际质押了 400 天才提取
- 奖励仍按 365 天计算：`本金 × 5% × (365/365) = 本金 × 5%`
...
**奖励池需求**：
- **Staking**：按 5% APY 计算所需奖励
- ****：按 16% APY 计算所需奖励（需要更多资金）
...
单层 Staking 产品方案通过差异化的产品设计，满足不同用户群体的需求：

- **Staking**：低门槛、稳健收益，面向普通用户
- ****：高门槛、高收益，面向大户和机构
