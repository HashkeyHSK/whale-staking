...
async function main() {
  ...
  if (!positionId) {
    throw new Error("Please provide positionId: POSITION_ID=1 npm run claim:premium:testnet or npm run claim:premium:testnet 1");
  }

  printSeparator("Claim Rewards (Premium Staking)");
