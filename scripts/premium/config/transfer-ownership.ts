...
/**
 * Transfer ownership of Premium Staking contract (Step 1 of 2)
 * 
...
async function main() {
  ...
  if (!newOwnerAddress) {
    throw new Error(
      ...
      "Method 1: NEW_OWNER_ADDRESS=\"0x...\" npm run config:transfer-ownership:premium:testnet\n" +
  ...
  console.log("\n📋 Next Steps:");
  console.log("  1. The new owner must call: npm run config:accept-ownership:premium:testnet");
  console.log("  2. Or use the script: scripts/premium/config/accept-ownership.ts");
