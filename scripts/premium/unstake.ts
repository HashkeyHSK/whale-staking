...
async function main() {
  ...
  if (!positionId) {
    throw new Error("Please provide positionId: POSITION_ID=1 npm run unstake:premium:testnet or npm run unstake:premium:testnet 1");
  }

  printSeparator("Unstake (Premium Staking)");
