...
/**
 * Upgrade Staking proxy contract to a new implementation
 * 
 * This script:
...
async function main() {
  ...
  const proxyAddress = process.env.STAKING_ADDRESS || getStakingAddress(network);

  printSeparator("Upgrade Staking Proxy Contract");
