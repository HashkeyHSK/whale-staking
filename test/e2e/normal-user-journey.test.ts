...
describe("Normal Staking - E2E User Journey", () => {
  ...
  test("长时间运行场景", async () => {
    ...
    try {
      ...
      // After 1 year, reward should be approximately 8% of stake amount
      const expectedReward = (stakeAmount * BigInt(800)) / BigInt(10000);
